 ...
 * @author Marcos
 */
public class JDlgPesquisarVenda extends javax.swing.JDialog {
    ...
    public JDlgPesquisarVenda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            LvbVenda venda = controllerVenda.getBean(jTable1.getSelectedRow());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgPesquisarVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgPesquisarVenda dialog = new JDlgPesquisarVenda(new javax.swing.JFrame(), true);
