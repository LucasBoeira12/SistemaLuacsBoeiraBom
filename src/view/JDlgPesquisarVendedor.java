 ...
 * @author Marcos
 */
public class JDlgPesquisarVendedor extends javax.swing.JDialog {
    ...
    public JDlgPesquisarVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
       ...
       if (jTable1.getSelectedRow() == -1) {
            ...
            LvbVendedor vendedor = controllerVendedor.getBean(jTable1.getSelectedRow());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgPesquisarVendedor dialog = new JDlgPesquisarVendedor(new javax.swing.JFrame(), true);
